...
const SPREADSHEET_ID = "1MZ9vXFvZRQpEvhPeeIxUYURCJe9BBl1w9-xuE9KRpzM";
...
function parseFile(
  ...
  if (isTxt) {
    // TXT: UTF-16 LE, tab-separated, encabezado en la primera fila (sin metadatos).
  ...
  // CSV: descarta 3 filas de metadatos, coma como separador.
...
export async function syncLecturas(files: { name: string; content: string }[]) {
