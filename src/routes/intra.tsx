...
import { syncIntraToSheet } from "@/lib/sync-intra.functions";

export const Route = createFileRoute("/intra")({
  head: () => ({
    meta: [
      { title: "Sincronizador Rociado Intradomiciliar" },
      {
        name: "description",
        content:
          "Sube archivos CSV o TXT de Rociado Intradomiciliar y sincroniza a Google Sheets.",
      },
    ],
  }),
  component: IntraPage,
...
type Result = Awaited<ReturnType<typeof syncIntraToSheet>>;

function IntraPage() {
  const sync = useServerFn(syncIntraToSheet);
    ...
    <div className="min-h-screen bg-background px-4 py-12">
      <div className="mx-auto max-w-2xl">
        ...
        <h1 className="mt-4 text-3xl font-bold tracking-tight text-foreground">
          Sincronizador Rociado Intradomiciliar
        </h1>
