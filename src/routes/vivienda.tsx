...
import { syncViviendaToSheet } from "@/lib/sync-vivienda.functions";

export const Route = createFileRoute("/vivienda")({
  head: () => ({
    meta: [
      { title: "Sincronizador Calidad de Vivienda" },
      {
        name: "description",
        content:
          "Sube archivos CSV o TXT de Calidad de Vivienda y sincroniza a Google Sheets.",
      },
    ],
  }),
...
type Result = Awaited<ReturnType<typeof syncViviendaToSheet>>;

function ViviendaPage() {
  const sync = useServerFn(syncViviendaToSheet);
    ...
    <div className="min-h-screen bg-background px-4 py-12">
      <div className="mx-auto max-w-2xl">
        ...
        <h1 className="mt-4 text-3xl font-bold tracking-tight text-foreground">
          Sincronizador Calidad de Vivienda
        </h1>
