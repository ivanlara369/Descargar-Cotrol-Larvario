  ...
  return (
    <div className="min-h-screen bg-background px-4 py-12">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mt-2 rounded-md border border-border bg-card p-3 text-sm">
          <span className="text-muted-foreground">¿Vas a subir Rociado a Caso? </span>
          <Link to="/rociado" className="font-medium text-primary hover:underline">
            Ir al Sincronizador Rociado a Caso →
          </Link>
        </div>
